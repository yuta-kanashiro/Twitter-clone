<template>
    <div>
        <i class="fas fa-plus-circle tweet-btn" @click="modalAction"></i>
                ...
                <div class="justify-content-center">
                    <form id="form" @submit="createTweet">
                        <div class="text-center">
                            ...
                            <div class="mt-2">
                                <textarea type="text" name="text" id="text" class="form-control" placeholder="ツイートしてみよう" maxlength="140" rows="10" required></textarea>
                            </div>
                        </div>
                        <div class="d-flex justify-content-center mt-3">
                            <button type="submit" id="btn" class="btn btn-info text-white rounded-pill me-2">ツイートする</button>
                            <button type="button" class="btn btn-dark rounded-pill" @click="modalAction">閉じる</button>
                        </div>
                    </form>
                </div>
            </div>
